...
@section('page-title', 'Create Shipping Setting')

@section('content')
<div class="max-w-2xl">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Create Shipping Setting</h1>
        <a href="{{ route('admin.shipping-settings.index') }}" class="text-blue-600 hover:text-blue-800">← Back to Shipping Settings</a>
    </div>

    <form action="{{ route('admin.shipping-settings.store') }}" method="POST" class="card">
        @csrf
        ...
        <div class="space-y-6">
            <div>
                ...
                <input type="text" name="district_name" value="{{ old('district_name') }}" required
                       class="form-input" placeholder="e.g., Dhaka, Outside Dhaka, Chittagong">
                <p class="text-sm text-gray-500 mt-1">Enter the district name (e.g., "Dhaka" or "Outside Dhaka")</p>
            ...
            <div>
                ...
                <input type="number" name="shipping_cost" value="{{ old('shipping_cost') }}" step="0.01" min="0" required
                       class="form-input" placeholder="50.00">
                <p class="text-sm text-gray-500 mt-1">Enter shipping charge in Taka (e.g., 50 for Dhaka, 60 for Outside Dhaka)</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" min="0"
                           class="form-input">
                    <p class="text-sm text-gray-500 mt-1">Lower numbers appear first in dropdown</p>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1 ml-7">Only active settings will be available in checkout</p>
                </div>
            </div>

            <div class="flex space-x-4 pt-4 border-t">
                <button type="submit" class="btn-primary">Create Shipping Setting</button>
